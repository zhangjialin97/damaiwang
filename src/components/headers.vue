      ...
      <li>
        ...
        <el-dropdown :show-timeout="num">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item><router-link to="/DD">订单管理</router-link></el-dropdown-item>
            <el-dropdown-item><router-link to="/Dr">常用信息人</router-link></el-dropdown-item>
            <el-dropdown-item><router-link to="/User">购买记录</router-link></el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </li>
    </ul>
